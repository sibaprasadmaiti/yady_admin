...
@Component({
  selector: 'app-addfaqcategory',
  templateUrl: './addfaqcategory.component.html',
  styleUrls: ['./addfaqcategory.component.scss']
})
export class AddfaqcategoryComponent implements OnInit {
  ...
  addData() {
   ...
   // updatejob.id = this.edit_job;
    ...
    this.adminservice.HttpPostReq(`admin/addfaqcategory?token=${this.logtoken}`, addcontent, true)
    .then(
      (response: any) => {
